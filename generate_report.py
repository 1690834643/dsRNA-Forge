...
def create_test_transcriptome():
    ...
    # 目标基因: 昆虫 P450 (真实碱基分布)
    t.sequences["GeneA_CYP6G1_target"] = (
        "AUGCGAAUUCGCGGAAACCCUUUGGGAAACCCUUUGGGAAACCCUUUGGGAAACCCUUUGGGAAACCCUUU"
        "GGGAAACCCUUUGGGAAACCCUUUGGGAAACCCUUUGGGAAACCCUUUGGGAAACCCUUUGGGAAACCCUUU"
        "CCGGAUUACCGGAUUACCGGAUUACCGGAUUACCGGAUUACCGGAUUACCGGAUUACCGGAUUACCGGAUUA"
    )
    # 脱靶基因: 与 GeneA 前 40nt 高度相似
    t.sequences["GeneB_CYP6A2_offtarget"] = (
        "AUGCGAAUUCGCGGAAACCCUUUGGGAAACCCUUUCCCGGGUUUAAACCCGGGUUUAAACCCGGGUUUAAA"
        "CCCGGGUUUAAACCCGGGUUUAAACCCGGGUUUAAACCCGGGUUUAAACCCGGGUUUAAACCCGGGUUUAAA"
        "GGCUUAGGCCGGCUUAGGCCGGCUUAGGCCGGCUUAGGCCGGCUUAGGCCGGCUUAGGCCGGCUUAGGCC"
    )
    # 无关基因
    t.sequences["GeneC_GST_unrelated"] = (
        "AUGGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUA"
        "GCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUA"
        "GCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUAGCUA"
    )
    t._compute_stats()
    return t
...
def run_design():
    ...
    result = task.run(t, "GeneA_CYP6G1_target", config)
    return result
        ...
        <div class="header-content">
            ...
            <div class="header-meta">
                <div class="header-meta-item">
                    ...
                    <span>生成时间: {os.path.getctime(__file__) if os.path.exists(__file__) else 'N/A'}</span>
                </div>
                <div class="header-meta-item">
...
if __name__ == "__main__":
    print("运行设计任务...")
    result = run_design()
    print(f"生成 {result['summary']['total_candidates']} 个候选")
